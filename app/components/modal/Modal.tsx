...
const Modal: React.FC<ModalProps> = ({ title, content, isOpen, close }) => {
  ...
  return (
    <div className="flex items-center justify-center fixed inset-0 z-50 bg-black/60">
      <div className="relative w-[90%] md:w-[55%] lg:w-[500px] my-6 mx-auto h-auto">
        <div
        ...
        >
          <div className="w-full h-auto rounded-xl relative flex flex-col bg-white shadow-md">
            <header className="h-[60px] flex items-center p-6 rounded-t justify-center relative border-b">
              ...
              <h2 className="text-lg font-bold leading-tight tracking-tight text-gray-900 md:text-lg">
                {title}
              </h2>
            </header>
